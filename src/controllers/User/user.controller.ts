...
// import handleImageUpload from "@/utils/handleImageUploadUtils";
// import { removeMulterUploadFiles } from "@/utils/removeMulterUploadFiles";
...
//   const avtarLocalPath = (req.files as { [fieldname: string]: Express.Multer.File[] } | undefined)?.avatar?.[0]?.path || null;
//   const coverImageLocalPath = (req.files as { [fieldname: string]: Express.Multer.File[] } | undefined)?.coverImage?.[0]?.path || null;
...
//   return res
//     .status(201)
//     .json(new ApiResponse(201, curretUser, "User Register Sucessfully"));
// });
...
// const logedOutUser = asyncHandler(async (req: Request, res: Response) => {
...
//   return res
//     .status(200)
//     .json(new ApiResponse(200, updatedUser, "User Avatar Updated Sucessfully"));
// });
...
//   handleImageUpload(coverImageLocalPath, currentImage, __PhotoDir.COVERIMAGE);
...
// const getProfileInformation = asyncHandler(async (req: Request, res: Response) => {
